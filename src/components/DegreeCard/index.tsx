...
import { RootDiv, TopRowDiv, DegreeNameDiv, DatesDiv, DescriptionDiv } from './styles';
import { Degree } from 'models/experience';

const DATE_FORMAT = 'MMMM yyyy';

export default function DegreeCard({ degree }: { degree: Degree }) {
    const { startDate, endDate, description, name } = degree,
    ...
    return (
        <RootDiv>
            <TopRowDiv>
                <DegreeNameDiv>{name}</DegreeNameDiv>
            </TopRowDiv>
